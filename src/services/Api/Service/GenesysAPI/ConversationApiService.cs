...
namespace Api.Service.GenesysAPI
{
    public class ConversationApiService : GenesysAPIService
    {
        ...
        public void SetIntervalExtract(DateTimeOffset from)
        {
            ...
            logger.LogInformation("Genesys Api interval extraction set: {interval}", IntervalExtract);
        }
        ...
        {
            logger.LogDebug("Analytics_ConversationsDetails_RequestJobAsync --> {interval}", IntervalExtract);
            ...
            {
                logger.LogError(ex, "Analytics_ConversationsDetails_RequestJobAsync error");
                return null;
            }
        }
        ...
        public async Task<AsyncQueryStatus?> Analytics_ConversationsDetails_GetJobStatusAsync(string jobId)
        {
            ...
            {
                logger.LogError(ex, "Analytics_ConversationsDetails_GetJobStatusAsync error");
                return null;
            }
        }
        ...
        public async Task<List<AnalyticsConversation>> Analytics_ConversationsDetails_GetJobResultsAsync(string jobId)
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    if (data != null)
                    {
                        if (isFirstRequest)
                        {
                            logger.LogInformation("Data available until '{Date}'", data.DataAvailabilityDate);
            ...
            {
                logger.LogError(ex, "Analytics_ConversationsDetails_GetJobResultsAsync error");
            }
