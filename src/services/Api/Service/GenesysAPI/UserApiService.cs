...
namespace Api.Service.GenesysAPI
{
    public class UserApiService : GenesysAPIService
    {
        ...
        {
            logger.LogDebug("Users_GetUserAsync --> pageSize={pagesize}, pageNumber={pageNumber}, state={state}", pageSize, pageNumber, state);
            ...
            {
                logger.LogError(ex, "Users_GetUsersAsync error");
                return null;
            }
        }
        ...
        {
            logger.LogDebug("Users_GetUserByIdAsync --> userId={userId}", userId);
            _genesysAuthService.CheckToken();
            ...
            {
                logger.LogError(ex, "Users_GetUserByIdAsync error");
                return null;
            }
        }
    }
